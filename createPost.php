...
<body>
  ...
  <div id="createPostTitle">Create your own Blog</div>

  <div id="createPostContainer">
    <form action="?" method="post" enctype="multipart/form-data">
      <input type="text" id="postTopic" placeholder="Blog Topic" name="postTopic" /> <br />
      <br />
      <div id="thumbnailTitle">Thumbnail</div>
      <input type="file" id="thumbnail" accept="image/*" name="thumbnail" /> <br />

      <br />
      <div id="imgVideoTitle">Upload Image related to Blog</div>
      <input type="file" id="acceptImgVideo" accept="image/*" name="file" />
      <br />
      <br />
      <br />
      <textarea id="postContent" placeholder="Write your blog here..." name="postContent"></textarea>
      <br />
      <br />
